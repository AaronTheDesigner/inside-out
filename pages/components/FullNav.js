...
const FullNav = () => {
  return (
    <div className="fullnav flex primary-dark justify-between w-0 -translate-y-full invisible sm:w-full sm:translate-y-0 sm:visible sm:py-1 lg:py-3 px-4 sm:px-10 md:px-15 lg:px-36">
        <div className="flex items-center w-0 sm:w-8/12 lg:justify-between sm:gap-x-5 lg:gap-x-20">
            <div className="sm:h-10 md:h-10 lg:h-14 lg:w-1/12">
                <svg width="64" height="74" viewBox="0 0 64 74" fill="none" xmlns="http://www.w3.org/2000/svg" className='sm:h-full md:h-full logo'>
        ...
        <div className="flex items-center w-0 sm:w-2/12">
