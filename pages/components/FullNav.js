...
const FullNav = () => {
  return (
    <div className="fullnav flex primary-dark justify-between w-full py-3 px-4 sm:px-10 md:px-15 lg:px-36">
        <div className="flex items-center w-6/12 justify-between gap-x-20">
            <div className="h-14 w-1/12">
            ...
            <div className="w-11/12">
                <ul className='flex gap-x-10 justify-evenly font-bold uppercase tracking-wider navlinks'>
                    <li>
                        <Link href="/">
