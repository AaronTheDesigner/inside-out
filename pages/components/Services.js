...
const Services = () => {
  return (
    <section id="services" className="services py-4 border-b-4 border-blue-900 sm:px-10 md:px-15 lg:px-20">
        <h1 className="m-2 text-3xl text-center font-bold text-blue-900 md:text-4xl">Bring new life to your home</h1>
        <div className="bg-slate-400 flex gap-7 flex-wrap justify-center">
