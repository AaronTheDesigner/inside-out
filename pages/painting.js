    ...
    <div className="flex flex-col py-4 sm:px-10 md:px-15 lg:px-20" style={{
      ...
      <div className='flex flex-col items-center'>
        ...
        <p className='p-4 text-xs text-center sm:text-sm md:text-base lg:text-lg'>
          We have built a team of skilled house painters who are committed to providing excellent painting services for every customer. On every project, our number one goal is client satisfaction.
        </p>
      </div>
