  ...
  return (
    <div>
      <div className="hero grid place-items-center border-b-4 border-blue-900">
        <div className="flex flex-col border-x-4 border-blue-900 gap-y-6 justify-center items-center bg-white w-4/5 drop-shadow-2xl sm:w-2/5 md:1/5">
          ...
          <div className="text-blue-900 text-center capitalize">
            <p className="uppercase drop-shadow- text-3xl md:text-4xl lg:text-5xl">
              site moto here
            </p>
          </div>
          <div className='mt-6'>
            <button className="bg-blue-900 hover:bg-blue-700 text-white font bold py-2 px-4 rounded drop-shadow-lg md:text-2xl md:py-4 md:px-6">
              Contact
            </button>
          </div>
      ...
      <section id="services" className="services h-screen">
